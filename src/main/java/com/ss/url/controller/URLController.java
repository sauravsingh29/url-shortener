...
public class URLController {
    ...
    public ResponseEntity<?> registerUrl(@RequestBody URLRequest urlRequest, @RequestHeader(value = "Authorization", required = true) String authorization, HttpServletRequest servletRequest) {
        ...
        try {
            String response = urlService.registerUrl(url, requestType, authorization, "https://localhost:8080/register");
